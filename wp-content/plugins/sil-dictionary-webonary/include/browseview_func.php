<?php
function categories_func2( $atts )
{
	global $wpdb;
...
<?php 
	print ("<h1>Hello Rick</h1>");

	$tempUseSemDom = get_option("useSemDomainNumbers");
	print ("<br>This database has useSemDomainNumber set to: $tempUseSemDom</br>");
	if( $tempUseSemDom != 0 )
	{
		echo "<br>This database has useSemDomainNumber set to: $tempUseSemDom</br>";
	}
	?>
...
add_shortcode( 'categories2', 'categories_func2' );
?>
...
function categories_func( $atts )
{
	...
	print("<br>qTransLang is $qTransLang</br>")
?>
	<style>
	   TD {font-size: 9pt; font-family: arial,helvetica; text-decoration: none; font-weight: bold;}
	   a.categorylink {text-decoration: none; color: navy; font-size: 15px;}
